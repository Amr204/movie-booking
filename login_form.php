		...
		<tr>
			<td align="center" valign="middle">
              ...
              <br><p id="passerror"></p><div id="msg"></div> </td>
					...
					<tr>
						<td align="center"><br />
						<button class="btn btn-primary " id="login" style="padding: 11px 22px; font-size: 15px;">Login</button>
					...
					<tr>
						<td align="left"><br />
						<span class="forgetpassword"><a href="forget_password.php"> Modify your Password ?</a></span></td>
