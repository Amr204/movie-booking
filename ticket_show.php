            ...
            <div class="col-lg-6 mx-auto">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <?php
                        include "config.php";
                        $result = mysqli_execute_query($conn, "SELECT c.movie,c.booking_date,c.show_time,c.seat,c.totalseat,c.price,c.payment_date,c.custemer_id,u.username,u.email,u.mobile,u.city,t.theater FROM customers c INNER JOIN user u on c.uid=u.id INNER JOIN theater_show t on c.show_time=t.show WHERE custemer_id = '?'", [$_SESSION['customer_id']]);
                        ...
                        <center>
                            <h3>Movie Name: <?php echo $row['movie']; ?></h3>
                        </center>
