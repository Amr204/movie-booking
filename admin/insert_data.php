...
if (isset($_POST['customers'])) {
	...
	$status = 1;
	$insert_record = mysqli_query($conn, "INSERT INTO customers (`uid`,`movie`,`show_time`,`seat`,`totalseat`,`price`,`payment_date`,`booking_date`,`custemer_id`)VALUES('" . $username_id . "','" . $movie . "','" . $show_time . "','" . $seat . "','" . $totalseat . "','" . $price . "','" . $payment . "','" . $booking . "','" . $customer_id . "')");
	if (!$insert_record) {
		echo "hii";
	} else {
