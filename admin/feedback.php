...
if (mysqli_num_rows($result) > 0) {
  while($row = mysqli_fetch_array($result)) {
    ...
    <tr>
              ...
              <td> <a href='./edit_feedback.php?feed=<?php echo $row['id'];?>' class="btn btn-primary btn-sm" role="button">Edit</a></td>
              <td> <a href='./delete_feedback.php?feed=<?php echo $row['id'];?>' class="btn btn-danger btn-sm "  role="button">delete</a></td>
            </tr> 
