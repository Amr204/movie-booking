...
<div>
    ...
    $result = mysqli_execute_query($conn, "SELECT * FROM customers WHERE show_time = '?' && movie = '?' && payment_date = '?'", [$time, $movie, $date]);
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <table>
                            <tr>
                                <td width="50%">
                                    <font color="blue" size="5px" style="font-family: Shruti;">Movie:</font>
                                </td>
                                <td bgcolor="79F9E2">
                                    <center>
                                        <font size=5 style="font-family: Shruti; "><?php echo $_GET['movie']; ?></font>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                <td width="50%">
                                    <font color="blue" size="5px" style="font-family: Shruti;">Time:</font>
                                </td>
                                <td bgcolor="ECF68C">
                                    <center>
                                        <font size=5 style="font-family: Shruti;"><?php echo $_GET['time']; ?></font>
                                    </center>
                                </td>
                            </tr>
                            <tr>
                                <td width="50%">
                                    <font color="blue" size="5px" style="font-family: Shruti;">Seat:</font>
                                </td>
                                <td> <input type="text" id="selectedtext" name="seats" placeholder="selected checkboxs"></td>
                            </tr>
                            <tr>
                                <td width="50%">
                                    <font color="blue" size="5px" style="font-family: Shruti;">Total Seat:</font>
                                </td>
                        ...
                        ?>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <a data-toggle="modal" data-target="#tailer_modal" class="form-control btn btn-primary py-2">
                                        <font style="color:white;">Payment Now
                                    </a>
                                </div>
                            </div>
