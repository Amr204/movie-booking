                        ...
                        <div class="tab-content">
                            <div class="row">
                                ...
                                if (isset($_POST['submit'])) {
                                    $show = $_POST['show'];
                                    $result = mysqli_execute_query($conn, "SELECT u.username,u.email,u.mobile,u.city,t.theater FROM user u INNER JOIN theater_show t on u.username = '?' WHERE t.show = '?'", [$username, $show]);
